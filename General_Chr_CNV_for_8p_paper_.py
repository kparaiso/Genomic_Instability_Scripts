...
class Aneuploidy:
    ...
    def pca_plot(self):
        ...
        fig_sample.savefig("PCA_" + self.cancer + '_' + str(self.chr) + self.arm + "_" + self.cond + "_Feb_12.png",
                           dpi=100)
        ...
        PCA_loadings.to_csv(self.cancer + "_" + str(self.chr) + self.arm + "_" + self.cond + "_PCA_loadings_Feb_12.txt",
                            sep="\t")
